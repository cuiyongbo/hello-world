...
In other words, the last character in a raw string cannot be a backslash 
unless you escape it (and then the backslash you use to escape it will be 
part of the string, too).
...
**Note** that Unicode string or Unicode object—they don’t really belong to the same type as strings. 
