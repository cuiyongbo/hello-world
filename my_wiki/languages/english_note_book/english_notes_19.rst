...
|
| low-water
| Definition: the state of the tide when at its lowest level.
| Synonyms: low-tide.
| Antonyms: high-water, high-tide.
| Usage: islets (an small island) visible at low tide.
| Usage: at high tide you have to go inland.
| Usage: the high tide of nationalism. [高潮]
|
